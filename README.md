...
<details>
  ...
  * Data para entrega final do projeto: `18/04/2024 23:59`.
...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-039-project-trybewallet-ts.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-039-project-trybewallet-ts`
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH39&template=betrybe/sd-0x-project-trybewallet-ts)
